...
PROMPT_FINAL = (
    ...
    "El líder DEBE ser exactamente uno de los nombres que aparecen en team_members y que figure en assignments. "
    "Está terminantemente prohibido inventar un nombre, usar uno externo al proyecto o dejar este campo vacío. "
    "Si no hay un candidato claro, elige al miembro con más horas asignadas. "
